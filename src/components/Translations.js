...
export const translations = {
  ...
  vi: {
    ...
    delete_log_button: "Xóa Lịch sử Log (Báo cáo)",
    ...
    empty_inventory_title: "Không có thiết bị nào trong kho",
    empty_inventory_text:
      "Hãy thay đổi bộ lọc hoặc nhập thêm thiết bị vào kho.",
    empty_pending_title: "Chưa có yêu cầu mua",
    empty_pending_text: "Thêm từ Danh sách Mẫu để bắt đầu tạo yêu cầu mua.",
    empty_purchasing_title: "Không có đơn hàng đang mua",
    empty_purchasing_text: "Các thiết bị đang đặt hàng sẽ hiển thị tại đây.",
    empty_purchased_title: "Chưa có hàng chờ nhập kho",
    empty_purchased_text: "Xác nhận mua và nhập số SN để đưa hàng vào kho.",
    empty_allocated_title: "Chưa có thiết bị đang sử dụng",
    empty_allocated_text:
      "Thiết bị đã bàn giao cho nhân viên sẽ hiển thị ở đây.",
    empty_reports_title: "Chưa có hoạt động nào",
    empty_reports_text:
      "Các hoạt động hệ thống sẽ hiển thị tại đây khi phát sinh.",
    home: "Trang chủ",
    ...
    toast_item_recalled_successfully: "Thu hồi thiết bị thành công!",
    ...
    location_maintenance: "Phòng Bảo trì",
    ...
    logout: "Đăng xuất",
    settings: "Cài đặt",
    loading_application: "Đang khởi động ứng dụng...",
    authenticating: "Đang xác thực...",
    initializing: "Đang khởi tạo...",
    logging_in: "Đang đăng nhập...",
    registering_button: "Đang đăng ký...",
    login_success: "Đăng nhập thành công!",
    loading_inventory_system: "Đang tải hệ thống kho...",
    preparing_dashboard: "Chuẩn bị bảng điều khiển...",
    almost_ready: "Sắp xong rồi...",
    welcome_back: "Chào mừng trở lại",
    user: "Người dùng",
    setting_up_your_workspace: "Đang thiết lập không gian làm việc của bạn...",
    feedback_title: "Phản hồi & Đánh giá",
    feedback_subtitle: "Giúp chúng tôi cải thiện ứng dụng",
    feedback_bug: "Báo lỗi",
    feedback_suggestion: "Gợi ý",
    feedback_improvement: "Cải tiến",
    feedback_other: "Khác",
    feedback_rating: "Đánh giá ứng dụng",
    feedback_category: "Loại phản hồi",
    feedback_description: "Mô tả chi tiết",
    feedback_title_placeholder: "Nhập tiêu đề ngắn gọn...",
    feedback_description_placeholder:
      "Mô tả chi tiết vấn đề hoặc gợi ý của bạn...",
    submit_feedback: "Gửi phản hồi",
    submitting: "Đang gửi...",
    feedback_success_title: "Cảm ơn bạn!",
    feedback_success_message: "Phản hồi của bạn đã được gửi thành công.",
    rating_1_star: "Rất không hài lòng",
    rating_2_star: "Không hài lòng",
    rating_3_star: "Bình thường",
    rating_4_star: "Hài lòng",
    rating_5_star: "Rất hài lòng",
    error_occurred: "Đã xảy ra lỗi",
    error_boundary_message: "Có lỗi xảy ra trong ứng dụng. Vui lòng thử lại.",
    try_again: "Thử lại",
    ...
    system_data_management: "Quản lý Dữ liệu Hệ thống",
    ...
    // Purchase view additional strings
    pending_purchase_item_desc:
      "Nhập giá cho thiết bị này trước khi bắt đầu mua.",
    enter_price: "Nhập giá",
    start_purchase: "Bắt đầu Mua",
    move_to: "Chuyển đến",
    ...
    editing_allocation_for: "Chỉnh sửa bàn giao",
    edit_allocation_details: "Chỉnh sửa thông tin bàn giao",
    edit_recipient: "Chỉnh sửa người nhận",
    ...
    select_items_to_add_to_purchase_request:
      "Chọn thiết bị để thêm vào yêu cầu mua",
    try_different_search_term: "Thử từ khóa tìm kiếm khác",
    items_found: "thiết bị tìm thấy",
    ...
    condition_damaged: "Hỏng hóc / Không sử dụng được",
    ...
    // Missing action keys in Reports
    "allocation-allocate": "Bàn giao",
    "allocation-recall": "Thu hồi",
    "inventory-damaged": "Đánh dấu hỏng",
    "inventory-bulk-category-move": "Chuyển danh mục hàng loạt",
    "master-list-add-legacy": "Thêm Mẫu (tồn kho cũ)",
    "master-list-delete-override": "Xóa Mẫu (Ghi đè)",
    condition_legacy_import: "Hàng tồn kho không qua mua hàng",
    recalled_prefix: "Hàng thu hồi: {conditionText}",
    condition_recalled: "Đã thu hồi: {note}",
    handover_info: "Thông tin Bàn Giao",
    ...
    giver_position: "Chức vụ Người giao",
    giver_department: "Phòng/Ban Người giao",
    maintenance_date: "Ngày bảo trì",
    import_date: "Ngày nhập kho",
    // Short labels for compact date display
    import_date_short: "Ngày nhập",
    export_date_short: "Ngày xuất",
    import_button_text: "Phục hồi (Import)",
    backup_button_text: "Sao lưu (Backup)",
    reset_button_text: "Xóa Dữ liệu (Reset All Data)",
    lang_vi: "Tiếng Việt",
    lang_en: "English",
    lang_zh: "中文",
    // Report details keys
    ...
    toast_bulk_move_category_success:
      "Đã chuyển thành công {count} thiết bị từ '{from}' sang '{to}'.",
    toast_bulk_move_category_error:
      "Không thể chuyển thiết bị giữa các danh mục.",
  ...
  //----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  en: {
    location_in_use: "In Use",
    info_chart_title: "Current Inventory Status",
    inventory_status_chart_title: "Current Inventory Status",
    ...
    delete_log_button: "Delete File Log (Reports Pages)",
    ...
    liquidation_empty_title: "Liquidation stock is empty.",
    liquidation_empty_text:
      "Unrepairable devices will be moved here for liquidation.",
    home: "Home",
    empty_inventory_title: "No devices in inventory",
    empty_inventory_text: "Adjust filters or import devices to the inventory.",
    empty_pending_title: "No purchase requests yet",
    empty_pending_text: "Add from Master List to start a purchase request.",
    empty_purchasing_title: "No ongoing purchases",
    empty_purchasing_text: "Items being ordered will appear here.",
    empty_purchased_title: "No items awaiting import",
    empty_purchased_text:
      "Confirm purchases and enter SNs to import into inventory.",
    empty_allocated_title: "No allocated devices",
    empty_allocated_text: "Devices allocated to employees will appear here.",
    empty_reports_title: "No activities yet",
    empty_reports_text: "System activities will show up here as they happen.",
    ...
    toast_item_recalled_successfully: "Item recalled successfully!",
    ...
    toast_email_not_verified: "Account not activated. Please check your email!",
    ...
    location_not_imported: "Not Imported",
    location_in_stock: "In Stock",
    location_maintenance: "Maintenance Room",
    location_liquidation_stock: "Liquidation Stock",
    repair_completed: "Repair Completed",
    mark_unrepairable: "Liquidate Device",
    ...
    loading_inventory_system: "Loading inventory system...",
    preparing_dashboard: "Preparing dashboard...",
    almost_ready: "Almost ready...",
    welcome_back: "Welcome back",
    user: "User",
    setting_up_your_workspace: "Setting up your workspace...",
    feedback_title: "Feedback & Rating",
    feedback_subtitle: "Help us improve the application",
    feedback_bug: "Bug Report",
    feedback_suggestion: "Suggestion",
    feedback_improvement: "Improvement",
    feedback_other: "Other",
    feedback_rating: "Rate this app",
    feedback_category: "Feedback Type",
    feedback_description: "Detailed Description",
    feedback_title_placeholder: "Enter a brief title...",
    feedback_description_placeholder:
    ...
    rating_1_star: "Very Dissatisfied",
    rating_2_star: "Dissatisfied",
    rating_3_star: "Neutral",
    rating_4_star: "Satisfied",
    rating_5_star: "Very Satisfied",
    ...
    system_data_management: "System Data Management",
    ...
    // --- INVENTORY VIEW ---
    search_inventory_placeholder: "Search devices in inventory, SN...",
    ...
    // Purchase view additional strings
    pending_purchase_item_desc:
      "Enter a price for this item before starting purchase.",
    ...
    editing_allocation_for: "Editing allocation",
    edit_allocation_details: "Edit allocation details",
    ...
    select_items_to_add_to_purchase_request:
      "Select items to add to purchase request",
    ...
    recall_reason_replacement: "User replaced/changed device",
    recall_reason_upgrade: "User upgraded device",
    condition_new: "Brand new (100%)",
    allocating: "Allocating from",
    recipient_name: "Recipient's Full Name",
    employee_id: "Employee ID",
    condition_on_handover: "Device Condition",
    condition_damaged: "Damaged / Unusable",
    confirm_allocation: "Confirm",
    recalling_from: "Recalling device",
    ...
    "allocation-recall": "Recall",
    "inventory-damaged": "Marked as Damaged",
    "inventory-bulk-category-move": "Bulk Category Move",
    "master-list-add-legacy": "Add Master (Legacy)",
    "master-list-delete-override": "Delete Master (Override)",
    condition_legacy_import: "Legacy (non-purchased) item",
    recalled_prefix: "Returned Item: {conditionText}",
    condition_recalled: "Recalled: {note}",
    handover_info: "Handover Information",
    condition_repaired: "Repaired: {note}",
    are_you_sure_reset_data: "Are you sure you want to delete all existing data?",
    cancellation_reason_placeholder:
      "Enter reason for cancellation (e.g., found a better supplier, change in needs...)",
    master_item_name_placeholder: "Enter the master item you want to add",
    ...
    giver_position: "Giver Position",
    giver_department: "Giver Department",
    maintenance_date: "Maintenance Date",
    import_date: "Import Date",
    // Short labels for compact date display
    import_date_short: "Import Date",
    export_date_short: "Export Date",
    import_button_text: "Restore (Import)",
    backup_button_text: "Backup",
    reset_button_text: "Reset All Data",
    lang_vi: "Vietnamese",
    lang_en: "English",
    lang_zh: "Chinese",
    // Report details keys
    ...
    toast_bulk_move_category_success:
      "Successfully moved {count} items from '{from}' to '{to}'.",
    toast_bulk_move_category_error: "Unable to move items between categories.",
    toast_bulk_move_success:
  ...
  zh: {
    ...
    inventory_status_chart_title: "当前库存状态",
    ...
    delete_log_button: "删除日志文件（报告页面）",
    toast_logs_deleted_successfully: "成功删除所有活动日志。",
    toast_error_deleting_logs: "删除活动日志时出错。",
    liquidation_empty_title: "清算库存为空。",
    liquidation_empty_text: "无法修复的设备将被移至此处进行清算。",
    home: "首页",
    empty_inventory_title: "库存中没有设备",
    empty_inventory_text: "请调整筛选条件或将设备导入库存。",
    empty_pending_title: "暂无采购请求",
    empty_pending_text: "从模板列表添加以开始创建采购请求。",
    empty_purchasing_title: "暂无进行中的采购",
    empty_purchasing_text: "正在订购的项目将显示在此处。",
    empty_purchased_title: "暂无待入库的项目",
    empty_purchased_text: "确认采购并输入序列号以导入库存。",
    empty_allocated_title: "暂无已分配设备",
    empty_allocated_text: "分配给员工的设备将显示在此处。",
    empty_reports_title: "暂无活动",
    empty_reports_text: "系统活动发生时会显示在此处。",
    ...
    please_enter_display_name: "请输入您的显示名称。",
    profile_update_failed: "个人资料更新失败。",
    complete_your_profile: "完善您的个人资料",
    setup_profile_welcome: "请输入您的显示名称以继续。",
    ...
    toast_item_recalled_successfully: "设备召回成功！",
    ...
    toast_email_not_verified: "账户未激活。请检查您的电子邮件！",
    toast_user_not_found: "账户不存在。请检查您的电子邮件。",
    toast_wrong_password: "密码不正确。请重试。",
    toast_invalid_email: "电子邮件格式无效。",
    toast_network_error: "网络连接错误。请检查您的互联网连接。",
    locale_string: "zh-CN",
    category_all: "所有类别",
    category_pc: "个人电脑",
    category_mini_pc: "迷你个人电脑",
    ...
    category_printer_ink: "打印机墨水",
    category_network_device: "网络设备",
    category_network_cable: "网线",
    category_other: "其他耗材",
    location_not_imported: "未入库",
    location_in_stock: "在库",
    location_maintenance: "维修室",
    location_liquidation_stock: "清算库存",
    repair_completed: "维修完成",
    mark_unrepairable: "清算设备",
    it_inventory: "IT库存管理",
    search: "搜索",
    category: "类别",
    status: "状态",
    ...
    logout: "登出",
    settings: "设置",
    loading_application: "正在加载应用程序...",
    authenticating: "正在验证...",
    initializing: "正在初始化...",
    logging_in: "正在登录...",
    registering_button: "正在注册...",
    login_success: "登录成功！",
    loading_inventory_system: "正在加载库存系统...",
    preparing_dashboard: "正在准备仪表板...",
    almost_ready: "即将完成...",
    welcome_back: "欢迎回来",
    user: "用户",
    setting_up_your_workspace: "正在设置您的工作区...",
    feedback_title: "反馈与评价",
    feedback_subtitle: "帮助我们改进应用程序",
    feedback_bug: "错误报告",
    feedback_suggestion: "建议",
    feedback_improvement: "改进",
    feedback_other: "其他",
    feedback_rating: "评价此应用",
    feedback_category: "反馈类型",
    feedback_description: "详细描述",
    feedback_title_placeholder: "输入简短标题...",
    feedback_description_placeholder: "详细描述您的问题或建议...",
    submit_feedback: "提交反馈",
    submitting: "正在提交...",
    feedback_success_title: "谢谢！",
    feedback_success_message: "您的反馈已成功提交。",
    rating_1_star: "非常不满意",
    rating_2_star: "不满意",
    rating_3_star: "一般",
    rating_4_star: "满意",
    rating_5_star: "非常满意",
    error_occurred: "发生错误",
    error_boundary_message: "应用程序发生错误。请重试。",
    try_again: "再试一次",
    reload_page: "重新加载页面",
    ...
    // --- INVENTORY VIEW ---
    search_inventory_placeholder: "搜索库存设备，序列号...",
    ...
    // Purchase view additional strings
    pending_purchase_item_desc: "在开始采购之前请输入该设备的价格。",
    enter_price: "输入价格",
    start_purchase: "开始采购",
    move_to: "移动到",
    ...
    editing_allocation_for: "正在编辑分配",
    edit_allocation_details: "编辑分配详情",
    edit_recipient: "编辑接收人",
    reason_for_cancellation: "取消原因",
    recall_device: "召回设备",
    information: "信息",
    add_to_purchase_request_from_master: "从主列表添加到采购请求",
    select_items_to_add_to_purchase_request: "选择要添加到采购请求的设备",
    try_different_search_term: "尝试不同的搜索词",
    items_found: "找到的设备",
    edit_failure_note: "编辑故障说明",
    display_name: "显示名称",
    change_password: "更改密码",
    recall_reason_resigned: "用户离职",
    recall_reason_replacement: "用户更换/替换设备",
    recall_reason_upgrade: "用户升级设备",
    allocating: "从...分配",
    recipient_name: "接收人姓名",
    employee_id: "员工编号",
    condition_on_handover: "设备状况",
    condition_damaged: "损坏/无法使用",
    ...
    // Missing action keys in Reports
    "allocation-allocate": "分配",
    "allocation-recall": "召回",
    "inventory-damaged": "标记为损坏",
    "inventory-bulk-category-move": "批量移动类别",
    "master-list-add-legacy": "添加模板（历史）",
    "master-list-delete-override": "删除模板（覆盖）",
    are_you_sure_reset_data: "你确定要删除所有数据吗?",
    condition_new: "全新 (100%)",
    recalled_prefix: "退回物品: {conditionText}",
    condition_recalled: "已收回: {note}",
    handover_info: "交接信息",
    condition_legacy_import: "非采购导入物品",
    condition_repaired: "已修复: {note}",
    cancellation_reason_placeholder: "输入取消原因（例如：找到更好的供应商，需求变更...）",
    master_item_name_placeholder: "输入您想添加的主项目",
    ...
    from_user: "来自用户",
    giver_name: "交接人",
    giver_position: "交接人职位",
    giver_department: "交接人部门",
    maintenance_date: "维修日期",
    import_date: "入库日期",
    // Short labels for compact date display
    import_date_short: "入库日期",
    export_date_short: "出库日期",
    ...
    toast_bulk_move_category_success:
      "已成功将 {count} 个项目从“{from}”移动到“{to}”。",
    toast_bulk_move_category_error: "无法在类别之间移动项目。",
    toast_bulk_move_success:
