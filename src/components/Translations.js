...
export const translations = {
  ...
  vi: {
    ...
    empty_inventory_text: "Hãy thay đổi bộ lọc hoặc nhập thêm thiết bị vào kho.",
    ...
    empty_allocated_text: "Thiết bị đã bàn giao cho nhân viên sẽ hiển thị ở đây.",
    empty_reports_title: "Chưa có hoạt động nào",
    empty_reports_text: "Các hoạt động hệ thống sẽ hiển thị tại đây khi phát sinh.",
    home: "Trang chủ",
  ...
  pending_purchase_item_desc: "Nhập giá cho thiết bị này trước khi bắt đầu mua.",
  ...
  edit_recipient: "Chỉnh sửa người nhận",
    ...
    select_items_to_add_to_purchase_request: "Chọn thiết bị để thêm vào yêu cầu mua",
  ...
  view_details: "Cần xem chi tiết",
    ...
    toast_bulk_move_category_error: "Không thể chuyển thiết bị giữa các danh mục.",
  ...
  empty_purchased_text: "Confirm purchases and enter SNs to import into inventory.",
  ...
  // Purchase view additional strings
  pending_purchase_item_desc: "Enter a price for this item before starting purchase.",
  ...
  edit_recipient: "Edit recipient",
    ...
    select_items_to_add_to_purchase_request: "Select items to add to purchase request",
