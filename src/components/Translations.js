...
export const translations = {
  ...
  vi: {
    ...
    feedback_description_placeholder: "Mô tả chi tiết vấn đề hoặc gợi ý của bạn...",
  ...
  en: {
    ...
    feedback_description_placeholder: "Describe your issue or suggestion in detail...",
    ...
    error_boundary_message: "An error occurred in the application. Please try again.",
    try_again: "Try Again",
