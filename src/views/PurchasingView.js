                    ...
                    <td className="px-4 py-3.5 text-center">
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg text-yellow-500 hover:bg-yellow-100 dark:hover:bg-yellow-900/30"
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center space-x-1 -mt-2 -mr-2">
                  ...
                  <button
                    onClick={() => onCancel("revert-purchasing", item)}
                    className="p-2 rounded-xl text-yellow-500 hover:bg-yellow-100 dark:hover:bg-yellow-900/30"
                    title={t("revert_to_pending")}
                  >
                    <RotateCcw className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => onCancel("cancel-purchasing", item)}
                    className="p-2 rounded-xl text-red-500 hover:bg-red-100 dark:hover:bg-red-900/30"
                    title={t("cancel_purchase")}
                  >
                    <XCircle className="w-4 h-4" />
                  </button>
