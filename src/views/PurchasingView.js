          ...
          {Object.entries(groupedByCategory).map(
            ([categoryId, items], catIndex) => {
              ...
              return (
                <div
                  key={categoryId}
                  className="border-2 border-purple-200 dark:border-purple-700 rounded-lg overflow-hidden animate-fadeIn"
                  style={{ animationDelay: `${catIndex * 0.05}s` }}
                >
                  <div
                    onClick={() => toggleExpand(categoryId)}
                    className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 hover:from-purple-100 hover:to-pink-100 cursor-pointer transition-all duration-200"
                  >
                  ...
                  {isExpanded && (
                    <div className="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                      {sortedSubItems.map((item, itemIndex) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200 animate-slideInLeft border-l-4 border-transparent hover:border-purple-300"
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 ml-4">
                            ...
                            <button
                              onClick={() =>
                                onCancel("cancel-purchasing", item)
                              }
