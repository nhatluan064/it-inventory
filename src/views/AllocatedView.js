          ...
          <table className="w-full text-xs table-fixed">
            <thead className="bg-white dark:bg-gray-800 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-4 py-3.5 text-right font-medium uppercase text-gray-500 dark:text-gray-400 border-b-2 w-48">
                  {t("quantity")}
                </th>
              </tr>
            </thead>
                        ...
                        >
                          <div className="p-2 text-xs">
                            <div className="grid grid-cols-12 gap-x-4 items-center p-2 rounded-t-md font-bold italic text-gray-600 dark:text-gray-400">
                              <div
                                className="col-span-3 text-left cursor-pointer select-none"
                                onClick={() =>
                              ...
                              <div
                                className="col-span-2 text-left cursor-pointer select-none"
                                onClick={() =>
                              ...
                              <div
                                className="col-span-1 text-left cursor-pointer select-none"
                                onClick={() =>
                                  requestSubSort(
                                    categoryId,
