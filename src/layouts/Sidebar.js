...
const Sidebar = ({
  ...
  const desktopClasses = `relative hidden lg:flex flex-col h-full bg-white dark:bg-gray-800 shadow-lg border-r dark:border-gray-700 transition-all duration-300 ease-in-out ${
